      ...
      <div class="row gy-4 portfolio-container">
        ...
        <div class="col-xl-4 col-md-6 portfolio-item filter-app">
          <div class="portfolio-wrap">
            <img src="assets/images/portfolio/Adarsh.png" class="img-fluid portfolio-image" alt="">
          </div>
        </div>
        <!-- Portfolio Item -->
        <div class="col-xl-4 col-md-6 portfolio-item filter-product">
          <div class="portfolio-wrap">
            <img src="assets/images/portfolio/Aura.png" class="img-fluid portfolio-image" alt="">
          </div>
        </div>
        <!-- Portfolio Item -->
        <div class="col-xl-4 col-md-6 portfolio-item filter-branding">
          <div class="portfolio-wrap">
            <img src="assets/images/portfolio/civilEnginerring.png" class="img-fluid portfolio-image" alt="">
          </div>
        </div>
        <!-- Portfolio Item -->
        ...
        <div class="col-xl-4 col-md-6 portfolio-item filter-app">
          <div class="portfolio-wrap">
            <img src="assets/images/portfolio/Kanku.png" class="img-fluid portfolio-image" alt="">
          </div>
        </div>
        <!-- Portfolio Item -->
        <div class="col-xl-4 col-md-6 portfolio-item filter-branding">
          <div class="portfolio-wrap">
            <img src="assets/images/portfolio/KDLC.png" class="img-fluid portfolio-image" alt="">
          </div>
        </div>
        <!-- Portfolio Item -->
        <div class="col-xl-4 col-md-6 portfolio-item filter-branding">
          <div class="portfolio-wrap">
            <img src="assets/images/portfolio/SeventhSense.png" class="img-fluid portfolio-image" alt="">
          </div>
        </div>
        <!-- Portfolio Item -->
        <div class="col-xl-4 col-md-6 portfolio-item filter-branding">
          <div class="portfolio-wrap">
            <img src="assets/images/portfolio/ShreeHospital.png" class="img-fluid portfolio-image" alt="">
          </div>
        </div>
        <!-- Portfolio Item -->
        <div class="col-xl-4 col-md-6 portfolio-item filter-branding">
          <div class="portfolio-wrap">
            <img src="assets/images/portfolio/SonaGroup.png" class="img-fluid portfolio-image" alt="">
          </div>
        </div>
        <!-- Portfolio Item -->
        <!-- <div class="col-xl-4 col-md-6 portfolio-item filter-branding">
  ...
  <div class="container" data-aos="fade-up">
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-lg-3 col-md-6 col-sm-12 mb-4" data-aos="zoom-in" data-aos-delay="300">
        <div class="team-member card shadow border-0 text-center">
          <div class="team-image position-relative">
            <img src="assets/images/teamImages/hr.jpg" alt="Vaishnavi Karpe" class="img-fluid rounded-circle mx-auto team-photo">
          </div>
          <div class="card-body">
